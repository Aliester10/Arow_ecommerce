...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        \Illuminate\Support\Facades\View::composer('*', function ($view) {
            ...
            $layoutFooterLinks = \App\Models\FooterLink::orderByRaw("FIELD(column_title, 'LAYANAN PELANGGAN', 'PENGIRIMAN', 'INFORMASI', 'METODE PEMBAYARAN')")->orderBy('order')->get()->groupBy('column_title');
