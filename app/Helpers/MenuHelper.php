...
class MenuHelper
{
    public static function getMainNavItems()
    {
        return [
            ...
            [
                'icon' => 'pages',
                'name' => 'Tampilan Website',
                'path' => '/admin/appearance',
                'subItems' => [
                    [
                        'name' => 'Header & Topbar',
                        'path' => '/admin/appearance/header',
                    ],
                    [
                        'name' => 'Footer',
                        'path' => '/admin/appearance/footer',
                    ],
                    [
                        'name' => 'Integrated Solutions',
                        'path' => '/admin/appearance/integrated-solutions',
                    ],
                ]
            ],
        ];
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'briefcase' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.75 7V5.5C7.75 4.25736 8.75736 3.25 10 3.25H14C15.2426 3.25 16.25 4.25736 16.25 5.5V7H19C20.2426 7 21.25 8.00736 21.25 9.25V17.5C21.25 18.7426 20.2426 19.75 19 19.75H5C3.75736 19.75 2.75 18.7426 2.75 17.5V9.25C2.75 8.00736 3.75736 7 5 7H7.75ZM9.25 5.5C9.25 5.08579 9.58579 4.75 10 4.75H14C14.4142 4.75 14.75 5.08579 14.75 5.5V7H9.25V5.5ZM5 8.5H19C19.4142 8.5 19.75 8.83579 19.75 9.25V17.5C19.75 17.9142 19.4142 18.25 19 18.25H5C4.58579 18.25 4.25 17.9142 4.25 17.5V9.25C4.25 8.83579 4.58579 8.5 5 8.5Z" fill="currentColor"></path></svg>',
