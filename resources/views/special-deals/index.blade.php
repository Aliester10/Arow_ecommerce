...
<div class="container mx-auto px-2 sm:px-4 py-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        @forelse($products as $product)
            <div class="flex flex-col h-full bg-white rounded-lg sm:rounded-xl border border-gray-200 overflow-hidden shadow-md group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                <a href="{{ route('products.show', $product->slug) }}" class="flex flex-col h-full">
                    ...
                    <div class="relative aspect-[4/3] overflow-hidden bg-white shrink-0">
                        ...
                        <div class="absolute top-2 right-2 bg-red-500 text-white px-2 py-1 rounded-full text-xs font-semibold z-20">
                    ...
                    <div class="flex flex-col flex-grow p-3 sm:p-4 bg-white">
                        <!-- Product Name -->
                        <h3 class="text-sm sm:text-base font-semibold text-gray-800 mb-2 sm:mb-3 line-clamp-2 leading-tight">
                            {{ $product->nama_produk }}
                        </h3>
        ...
        @empty
            <div class="col-span-2 sm:col-span-3 lg:col-span-4 w-full text-center py-12 sm:py-16 bg-white rounded-lg sm:rounded-xl border border-dashed border-gray-300">
