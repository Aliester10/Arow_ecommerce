...
@section('title', 'Tambah Sub Sub Kategori')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-gray-500">Tambah Sub Sub Kategori</span>
                </div>
            </li>
        </ol>
    </nav>
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-stroke dark:border-gray-700">
    <div class="px-6 py-4 border-b border-stroke dark:border-gray-700">
        <h3 class="text-lg font-semibold text-black dark:text-white">Tambah Sub Sub Kategori Baru</h3>
    </div>
    
    <form method="POST" action="{{ route('admin.sub-sub-categories.store') }}" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('nama_sub_subkategori') }}"
                       required
            ...
            <div>
                ...
                <select name="id_subkategori" 
                    ...
                    @foreach ($subCategories as $subCategory)
                        <option value="{{ $subCategory->id_subkategori }}" {{ old('id_subkategori') == $subCategory->id_subkategori ? 'selected' : '' }}>
