...
@section('content')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-gray-700 dark:bg-gray-800">
            ...
            <form action="{{ route('admin.footer_links.store') }}" method="POST" enctype="multipart/form-data"
                x-data="{ type: 'text' }">
                @csrf
                <div class="p-6.5">
                    <div class="mb-4.5">
                        ...
                        <input type="text" name="column_title" value="{{ old('column_title') }}" required
                            placeholder="Contoh: Layanan Pelanggan" list="column_titles"
                    ...
                    <div class="mb-4.5" x-show="type === 'image'">
                        <label class="mb-2.5 block text-black dark:text-white">
                            Upload Gambar <span class="text-meta-1">*</span>
                        </label>
