                        ...
                        <div class="p-5">
                            ...
                            <div class="mb-4 flex flex-col gap-4 xl:flex-row">
                                <div class="w-full xl:w-1/2">
                                    ...
                                    <div class="relative z-20 bg-transparent dark:bg-gray-700">
                                        <select id="id_subkategori" name="id_subkategori" disabled
                                            class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-2.5 px-4 text-sm outline-none transition focus:border-primary active:border-primary disabled:bg-whiter disabled:cursor-not-allowed dark:border-gray-500 dark:bg-gray-700 dark:focus:border-primary dark:disabled:bg-black">
                                ...
                                <div class="w-full xl:w-1/2">
                                    ...
                                    <div class="relative z-20 bg-transparent dark:bg-gray-700">
                                        <select id="id_sub_subkategori" name="id_sub_subkategori" disabled
                                            class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-2.5 px-4 text-sm outline-none transition focus:border-primary active:border-primary disabled:bg-whiter disabled:cursor-not-allowed dark:border-gray-500 dark:bg-gray-700 dark:focus:border-primary dark:disabled:bg-black">
                            ...
                            <div class="mb-4 flex flex-col gap-4 xl:flex-row">
                                <div class="w-full xl:w-1/2">
                                    ...
                                    <textarea name="spesifikasi_produk" rows="5"
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-2.5 px-4 text-sm font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-gray-500 dark:bg-gray-700 dark:focus:border-primary">{{ old('spesifikasi_produk') }}</textarea>
                                </div>
                                <div class="w-full xl:w-1/2">
                                    <label class="mb-1.5 block text-sm font-medium text-black dark:text-white">
                                    ...
                                    <textarea name="deskripsi_produk" rows="5" required
                                        class="w-full rounded border-[1.5px] border-stroke bg-transparent py-2.5 px-4 text-sm font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-gray-500 dark:bg-gray-700 dark:focus:border-primary">{{ old('deskripsi_produk') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">Pilih beberapa gambar. Gambar
                                ...
                                <div class="relative z-20 bg-transparent dark:bg-gray-700">
                                    <select name="status_produk" required
                                        ...
                                        <option value="aktif" {{ old('status_produk') == 'aktif' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="nonaktif" {{ old('status_produk') == 'nonaktif' ? 'selected' : '' }}>
                                            Nonaktif</option>
                                    </select>
                                    <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2">
                                        <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            kategoriSelect.addEventListener('change', function () {
                ...
                subSubkategoriSelect.disabled = true;
                    ...
                    fetch(`/admin/products/get-subcategories/${kategoriId}`)
                        ...
                        .then(data => {
                            if (data.length > 0) {
                                ...
                                data.forEach(sub => {
                                    subkategoriSelect.innerHTML += `<option value="${sub.id_subkategori}">${sub.nama_subkategori}</option>`;
                                });
                            }
                        })
            ...
            subkategoriSelect.addEventListener('change', function () {
                ...
                if (subkategoriId) {
                    fetch(`/admin/products/get-sub-subcategories/${subkategoriId}`)
                        ...
                        .then(data => {
                            if (data.length > 0) {
                                subSubkategoriSelect.disabled = false;
                                data.forEach(subSub => {
                                    subSubkategoriSelect.innerHTML += `<option value="${subSub.id_sub_subkategori}">${subSub.nama_sub_subkategori}</option>`;
                                });
                            }
                        })
