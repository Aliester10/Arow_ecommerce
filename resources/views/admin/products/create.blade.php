                                    ...
                                    <div class="w-full xl:w-1/2">
                                        ...
                                        <div class="relative z-20 bg-transparent dark:bg-gray-700">
                                            <select id="id_subkategori" name="id_subkategori" disabled
                                                class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary disabled:bg-whiter disabled:cursor-not-allowed dark:border-gray-500 dark:bg-gray-700 dark:focus:border-primary dark:disabled:bg-black">
