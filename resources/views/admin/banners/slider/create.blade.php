        ...
        <div class="grid grid-cols-1 gap-9 sm:grid-cols-2">
            <div class="flex flex-col gap-9 sm:col-span-2">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg mx-6.5 mt-6.5">
                        <div class="flex items-center">
                            ...
                            <div class="text-sm text-blue-700">
                                <strong>Slider Banner:</strong> Banner ini akan ditampilkan di halaman utama sebagai slider. 
                    ...
                    <form action="{{ route('admin.slider-banners.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="p-6.5">
                            <div class="mb-4.5">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}" placeholder="Judul Slider Banner"
                            ...
                            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                ...
                                <div class="w-full xl:w-1/2 flex items-center pt-8">
                                    <label for="active" class="flex cursor-pointer select-none items-center">
                                        <div class="relative">
                                            <input type="checkbox" id="active" name="active" value="1" class="sr-only" checked />
                                            <div class="block h-8 w-14 rounded-full bg-meta-9 dark:bg-[#5A616B]"></div>
                                            <div class="dot absolute left-1 top-1 h-6 w-6 rounded-full bg-white transition" style="transform: translateX(1.5rem); background-color: rgb(99, 102, 241);"></div>
                                        </div>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-2.5 block text-black dark:text-white">
                                    Gambar Slider Banner <span class="text-meta-1">*</span>
                                </label>
                                <input type="file" name="gambar_slider_banner" id="gambar_slider_banner" required accept="image/*"
