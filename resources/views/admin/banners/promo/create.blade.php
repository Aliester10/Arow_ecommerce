                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <form action="{{ route('admin.promo-banners.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-6.5">
                                ...
                                <div class="relative z-20 bg-transparent dark:bg-form-input">
                                    <select name="id_promo_detail"
                                        ...
                                        @foreach(App\Models\PromoDetail::get() as $promoDetail)
                                            <option value="{{ $promoDetail->id_promo_detail }}" {{ old('id_promo_detail') == $promoDetail->id_promo_detail ? 'selected' : '' }}>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-2.5 block text-black dark:text-white">
                                    Gambar Informasi Banner <span class="text-meta-1">*</span>
                                </label>
                                <input type="file" name="gambar_promo_banner" id="gambar_promo_banner" required accept="image/*"
