                    ...
                    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-6.5">
                                ...
                                <div class="relative z-20 bg-transparent dark:bg-form-input">
                                    <select name="type" required
                                        ...
                                        <option value="promo_large" {{ old('type') == 'promo_large' ? 'selected' : '' }}>Promo
                                            Large (Kiri)</option>
                                        <option value="promo_small" {{ old('type') == 'promo_small' ? 'selected' : '' }}>Promo
                                            Small (Kanan)</option>
                                    </select>
                            ...
                            <div class="mb-4.5">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}" placeholder="Judul Banner"
                            ...
                            <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                ...
                                <div class="w-full xl:w-1/2 flex items-center pt-8">
                                    <label for="active" class="flex cursor-pointer select-none items-center">
                                        <div class="relative">
                                            <input type="checkbox" id="active" name="active" class="sr-only" checked />
                                            <div class="block h-8 w-14 rounded-full bg-meta-9 dark:bg-[#5A616B]"></div>
                                            <div class="dot absolute left-1 top-1 h-6 w-6 rounded-full bg-white transition">
                                            </div>
                                        </div>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-2.5 block text-black dark:text-white">
                                    Gambar Banner <span class="text-meta-1">*</span>
                                </label>
                                <input type="file" name="gambar_banner" id="gambar_banner" required accept="image/*"
