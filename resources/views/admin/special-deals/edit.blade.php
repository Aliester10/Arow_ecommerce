                    ...
                    <div class="border rounded-lg p-4 max-h-96 overflow-y-auto">
                        <div id="products-checkbox-list">
                            @foreach($products as $product)
                                ...
                                @endphp
                                <div class="product-checkbox-item mb-3 p-3 border rounded hover:bg-gray-50 dark:hover:bg-gray-700 {{ $isSelected ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800' : '' }}" data-product-name="{{ strtolower($product->nama_produk) }}" data-discount="{{ $discountPercentage }}">
                                    <label class="flex items-center cursor-pointer">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            @if($isSelected)
                                                <div class="text-xs text-blue-600 dark:text-blue-400 font-medium">Diskon: {{ $discountPercentage }}%</div>
                                            @endif
                                        </div>
                                    </label>
                                </div>
                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-blue-800 dark:text-blue-200">
                                Produk yang dipilih: <span id="selected-count">{{ $specialDeal->products->count() }}</span>
                            </span>
