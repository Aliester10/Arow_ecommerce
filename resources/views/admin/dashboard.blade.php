...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <!-- Products Stat -->
        <div class="bg-white rounded-xl shadow-sm border p-6 flex items-center gap-5 hover:shadow-md transition-shadow">
            <div
        ...
        <div class="bg-white rounded-xl shadow-sm border p-6 flex items-center gap-5 hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800">{{ $brandCount }}</h3>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border p-6 flex items-center gap-5 hover:shadow-md transition-shadow">
            ...
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-800">{{ $bannerCount }}</h3>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-8">
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-800">Selamat Datang di Admin Panel!</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="{{ route('admin.products.create') }}"
                class="group p-4 border rounded-lg hover:border-orange-500 hover:bg-orange-50 transition-all flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <i class="fas fa-plus-circle text-gray-400 group-hover:text-orange-500 transition-colors"></i>
                    <span class="font-medium text-gray-700 group-hover:text-orange-700">Tambah Produk Baru</span>
                </div>
                <i
            ...
            <a href="{{ route('admin.brands.create') }}"
                ...
                <div class="flex items-center gap-4">
                    <i class="fas fa-plus-circle text-gray-400 group-hover:text-orange-500 transition-colors"></i>
                    <span class="font-medium text-gray-700 group-hover:text-orange-700">Tambah Brand Baru</span>
                </div>
                <i
                    class="fas fa-chevron-right text-gray-300 group-hover:text-orange-400 transition-all transform group-hover:translate-x-1"></i>
            </a>
