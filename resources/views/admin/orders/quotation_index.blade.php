            ...
            <table class="w-full table-auto">
                <thead>
                    <tr class="bg-gray-2 text-left dark:bg-gray-700">
                        ...
                        <th class="min-w-[160px] py-4 px-4 font-medium text-black dark:text-white">Status Quotation</th>
                ...
                <tbody>
                    @forelse($orders as $order)
                        ...
                        <tr>
                            ...
                            <td class="border-b border-[#eee] py-5 px-4 dark:border-gray-700">
                                <p class="text-black dark:text-white font-medium">{{ strtoupper($order->quotation->status_quotation ?? 'DRAFT') }}</p>
                            </td>
                            <td class="border-b border-[#eee] py-5 px-4 dark:border-gray-700">
