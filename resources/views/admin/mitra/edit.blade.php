        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="flex flex-col gap-6 lg:col-span-2">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <form action="{{ route('admin.mitra.update', $mitra->id) }}" method="POST" enctype="multipart/form-data" class="p-6.5">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4.5">
                            ...
                            <input type="file" name="logo"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                accept="image/*">
                            <p class="text-sm text-gray-500 mt-1">Format: JPEG, PNG, JPG, GIF, SVG (Max: 2MB). Kosongkan jika tidak ingin mengganti logo.</p>
                            @if($mitra->logo)
                                <p class="text-sm text-blue-600 mt-1">Logo saat ini: <img src="{{ asset($mitra->logo) }}" alt="Current Logo" class="inline-block h-8 w-auto ml-2"></p>
                            @endif
                        </div>
                        ...
                        <div class="mb-4.5">
                            ...
                            <textarea name="deskripsi" rows="4"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                placeholder="Masukkan deskripsi mitra">{{ old('deskripsi', $mitra->deskripsi) }}</textarea>
                        </div>
                            ...
                            <div class="mb-4.5">
                                ...
                                <div class="flex items-center space-x-3 mt-4">
                                    <label class="flex items-center cursor-pointer">
                                        <input type="checkbox" name="aktif" value="1" {{ old('aktif', $mitra->aktif) ? 'checked' : '' }}
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="p-6.5">
                        <div id="logoPreview" class="flex items-center justify-center h-32 bg-gray-50 dark:bg-gray-700 rounded-lg border border-stroke dark:border-gray-600">
                            @if($mitra->logo)
                                <img src="{{ asset($mitra->logo) }}" alt="Current Logo" class="max-h-full max-w-full object-contain">
                            @else
