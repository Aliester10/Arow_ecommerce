...
@section('title', 'Tambah Detail Informasi')
...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah Detail Informasi</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Untuk banner: {{ $promoBanner->title ?? 'Informasi Banner' }}
                </p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
        <form action="{{ route('admin.promo-details.store', $promoBanner->id_promo_banner) }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="judul_detail" value="{{ old('judul_detail') }}" required
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="4" 
                                      class="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white px-4 py-2 focus:ring-2 focus:ring-primary focus:border-transparent">{{ old('deskripsi') }}</textarea>
                        </div>
