                    ...
                    <div class="flex items-start justify-between gap-6">
                        <div>
                            ...
                            <div class="mt-4 text-sm text-gray-600">
                                ...
                                <div>Permintaan quotation kamu sudah dibuat. Tim kami akan memproses penawaran sebelum
                                    pembayaran.</div>
                            </div>
                        </div>
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-xs text-gray-400 mt-1">Status Quotation:
                                {{ strtoupper($order->quotation->status_quotation ?? 'DRAFT') }}</div>
                        </div>
                    </div>

                    <div class="mt-6 flex flex-col sm:flex-row gap-3">
                        <a href="{{ route('checkout.quotation.download', $order->id_order) }}"
                            class="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-orange-600 text-white font-semibold hover:bg-orange-700 transition">
